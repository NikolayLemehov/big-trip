...
/* harmony import */ var _models_event_adapter_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/event-adapter-model */ "./src/models/event-adapter-model.js");
/* harmony import */ var _models_destination_adapter_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/destination-adapter-model */ "./src/models/destination-adapter-model.js");
/* harmony import */ var _models_offer_adapter_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/offer-adapter-model */ "./src/models/offer-adapter-model.js");
...
class Index {
  ...
  getPoints() {
    return this._load({url: `points`})
      ...
      .then(_models_event_adapter_model__WEBPACK_IMPORTED_MODULE_0__["default"].parseEvents);
  }
  ...
  createPoint(eventAdapterModel) {
    return this._load({
      ...
      .then((response) => response.json())
      .then(_models_event_adapter_model__WEBPACK_IMPORTED_MODULE_0__["default"].parseEvent);
  }
  ...
  getDestinations() {
    return this._load({url: `destinations`})
      .then((response) => response.json())
      .then(_models_destination_adapter_model__WEBPACK_IMPORTED_MODULE_1__["default"].parseDestination);
  }

  getOffers() {
    return this._load({url: `offers`})
      .then((response) => response.json())
      .then(_models_offer_adapter_model__WEBPACK_IMPORTED_MODULE_2__["default"].parseOffers);
  }
...
/*!*****************************!*\
  !*** ./src/api/provider.js ***!
  \*****************************/
/*! exports provided: StoreId, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _models_event_adapter_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/event-adapter-model */ "./src/models/event-adapter-model.js");
/* harmony import */ var _models_destination_adapter_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/destination-adapter-model */ "./src/models/destination-adapter-model.js");
/* harmony import */ var _models_offer_adapter_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/offer-adapter-model */ "./src/models/offer-adapter-model.js");
...
class Provider {
  ...
  getPoints() {
    ...
    return Promise.resolve(_models_event_adapter_model__WEBPACK_IMPORTED_MODULE_1__["default"].parseEvents(storeEvents));
  }
  ...
  createPoint(eventAdapterModel) {
    ...
    this._isSynchronized = false;
    const fakeNewEventId = nanoid__WEBPACK_IMPORTED_MODULE_0___default()();
    const fakeNewEventAdapterModel = _models_event_adapter_model__WEBPACK_IMPORTED_MODULE_1__["default"].parseEvent(Object
  ...
  updatePoint(id, eventAdapterModel) {
    ...
    this._isSynchronized = false;
    const fakeUpdatedEventAdapterModel = _models_event_adapter_model__WEBPACK_IMPORTED_MODULE_1__["default"].clone(eventAdapterModel);
  ...
  getDestinations() {
    ...
    return Promise.resolve(_models_destination_adapter_model__WEBPACK_IMPORTED_MODULE_2__["default"].parseDestination(storeDestinations));
  }
  ...
  getOffers() {
    ...
    return Promise.resolve(_models_offer_adapter_model__WEBPACK_IMPORTED_MODULE_3__["default"].parseOffers(storeOffers));
  }
...
/* harmony import */ var _provider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./provider */ "./src/api/provider.js");
...
class Store {
  constructor(storeKey, localStorage) {
    ...
    this._parsedStore = {
      [_provider__WEBPACK_IMPORTED_MODULE_0__["StoreId"].EVENTS]: {},
      [_provider__WEBPACK_IMPORTED_MODULE_0__["StoreId"].DESTINATION]: [],
      [_provider__WEBPACK_IMPORTED_MODULE_0__["StoreId"].OFFERS]: [],
    };
  }

  getEvents() {
    try {
      this._parsedStore[_provider__WEBPACK_IMPORTED_MODULE_0__["StoreId"].EVENTS] = JSON.parse(this._localStorage.getItem(this._storeKey))[_provider__WEBPACK_IMPORTED_MODULE_0__["StoreId"].EVENTS];
      return Object.values(this._parsedStore[_provider__WEBPACK_IMPORTED_MODULE_0__["StoreId"].EVENTS]);
    } catch (err) {
      return [];
    }
  }
  ...
  setEvents(events) {
    events.forEach((it) => {
      this._parsedStore[_provider__WEBPACK_IMPORTED_MODULE_0__["StoreId"].EVENTS][it.id] = it;
    });
    this._copyToLocalStore();
  }

  setEvent(key, value) {
    this._parsedStore[_provider__WEBPACK_IMPORTED_MODULE_0__["StoreId"].EVENTS][key] = value;
    this._copyToLocalStore();
  }

  removeEvent(key) {
    delete this._parsedStore[_provider__WEBPACK_IMPORTED_MODULE_0__["StoreId"].EVENTS][key];
    this._copyToLocalStore();
  }
...
/***/ "./src/components/day-info-component.js":
/*!**********************************************!*\
  !*** ./src/components/day-info-component.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DayInfoComponent; });
...
const createDayInfoTemplate = (date, dayCount = null) => {
  ...
  if (dayCount) {
    ...
    const month = moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`MMM`);
...
class DayInfoComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/***/ "./src/components/empty-component.js":
/*!*******************************************!*\
  !*** ./src/components/empty-component.js ***!
  \*******************************************/
/*! exports provided: default */
...
class EmptyComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return (
...
/***/ "./src/components/event-component.js":
/*!*******************************************!*\
  !*** ./src/components/event-component.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventComponent; });
...
const createEventTemplate = (event) => {
  ...
  const price = he__WEBPACK_IMPORTED_MODULE_0___default.a.encode(String(notSanitizedPrice));
  const startJSONDate = date.start ? date.start.toJSON() : ``;
  const endJSONDate = date.end ? date.end.toJSON() : ``;
  const startFormattedDate = date.start ? Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(date.start) : ``;
  const endFormattedDate = date.end ? Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(date.end) : ``;
  const duration = date.start && date.end ? Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getDuration"])(date.start, date.end) : ``;
  const preposition = _const__WEBPACK_IMPORTED_MODULE_3__["groupTypeToPreposition"].get(_const__WEBPACK_IMPORTED_MODULE_3__["typeToGroup"].get(type));
  ...
  return (
    `<li class="trip-events__item">
      <div class="event">
        ...
        <h3 class="event__title">${type} ${preposition} ${he__WEBPACK_IMPORTED_MODULE_0___default.a.encode(destination.city)}</h3>
...
class EventComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(event) {
    super();
    this._event = event;
  }
...
/***/ "./src/components/event-edit-component.js":
/*!************************************************!*\
  !*** ./src/components/event-edit-component.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventEditComponent; });
/* harmony import */ var he__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! he */ "./node_modules/he/he.js");
/* harmony import */ var he__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(he__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _abstract_smart_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./abstract-smart-component */ "./src/components/abstract-smart-component.js");
/* harmony import */ var _utils_debounce__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/debounce */ "./src/utils/debounce.js");
...
const createEventTypeGroupTemplate = (group, checkedType) => {
  const eventTypesTemplate = Array.from(_const__WEBPACK_IMPORTED_MODULE_4__["groupToTypes"].get(group)).map((it) => eventTypeTemplate(it, checkedType)).join(``);
  return (
...
const createEditEventTemplate = (event, destinations, option) => {
  ...
  const price = he__WEBPACK_IMPORTED_MODULE_0___default.a.encode(String(notSanitizedPrice));
  const startDate = date.start ? `${Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["formatDate"])(date.start)} ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["formatTime"])(date.start)}` : ``;
  const endDate = date.start ? `${Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["formatDate"])(date.end)} ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["formatTime"])(date.end)}` : ``;
  const preposition = _const__WEBPACK_IMPORTED_MODULE_4__["groupTypeToPreposition"].get(_const__WEBPACK_IMPORTED_MODULE_4__["typeToGroup"].get(type));

  const offersMarkUp = offers.length > 0 ? offers.map((it) => createOfferTemplate(it)).join(``) : ``;
  const eventTypeGroupsTemplate = Array.from(_const__WEBPACK_IMPORTED_MODULE_4__["groupToTypes"].keys()).map((it) => createEventTypeGroupTemplate(it, type)).join(``);

  const photoElementsTemplate = destination.photos
    .map((it) => `<img class="event__photo" src="${it.src}" alt="${it.description}">`).join(``);
  const cityOptionsTemplate = destinations.map((it) => `<option value="${he__WEBPACK_IMPORTED_MODULE_0___default.a.encode(it.city)}"></option>`).join(``);
    ...
    `<form class="trip-events__item  event  event--edit" action="#" method="post">
      <header class="event__header">
        ...
        <div class="event__field-group  event__field-group--destination">
          ...
          <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination"
            value="${he__WEBPACK_IMPORTED_MODULE_0___default.a.encode(destination.city)}" list="destination-list-1">
      ...
      <section class="event__details">
        ...
        ${hasDestination ? `<section class="event__section  event__section--destination">
          ...
          <p class="event__destination-description">${he__WEBPACK_IMPORTED_MODULE_0___default.a.encode(destination.description)}</p>
...
class EventEditComponent extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_5__["default"] {
  ...
  rerender(onFocusElement = null) {
    ...
    this._startDate = this.getElement()[`event-start-time`].value ?
      moment__WEBPACK_IMPORTED_MODULE_2___default()(this.getElement()[`event-start-time`].value, DateFormat.MOMENT).format() : null;
    this._endDate = this.getElement()[`event-end-time`].value ?
      moment__WEBPACK_IMPORTED_MODULE_2___default()(this.getElement()[`event-end-time`].value, DateFormat.MOMENT).format() : null;
    super.rerender();
  ...
  setFavoriteToggleHandler(handler) {
    const debounceHandler = Object(_utils_debounce__WEBPACK_IMPORTED_MODULE_6__["debounce"])(handler, DEBOUNCE_DELAY);
  ...
  _applyFlatpickr() {
    ...
    this._startFlatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_1___default()(startDateElement, {
      'altInput': true,
      'allowInput': true,
      ...
      onChange(selectedDates, dateStr, instance) {
        startValue = moment__WEBPACK_IMPORTED_MODULE_2___default()(instance.selectedDates[0]).add(1, `minute`).format(DateFormat.MOMENT);
      },
    ...
    this._endFlatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_1___default()(endDateElement, {
      'altInput': true,
      'allowInput': true,
      'altFormat': DateFormat.FLATPICKR,
      'dateFormat': DateFormat.FLATPICKR,
      ...
      onChange(selectedDates, dateStr, instance) {
        endValue = moment__WEBPACK_IMPORTED_MODULE_2___default()(instance.selectedDates[0]).subtract(1, `minute`).format(DateFormat.MOMENT);
      },
      onOpen(selectedDates, dateStr, instance) {
        if (startValue) {
...
/***/ "./src/components/filter-list-component.js":
/*!*************************************************!*\
  !*** ./src/components/filter-list-component.js ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilterListComponent; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
...
class FilterListComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(filters) {
    super();
...
/***/ "./src/components/filter-list-title-component.js":
/*!*******************************************************!*\
  !*** ./src/components/filter-list-title-component.js ***!
  \*******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilterListTitleComponent; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");


class FilterListTitleComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return (
...
/***/ "./src/components/site-menu-component.js":
/*!***********************************************!*\
  !*** ./src/components/site-menu-component.js ***!
  \***********************************************/
/*! exports provided: default */
...
class SiteMenuComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(names) {
    super();
    this._names = names;
    this._activeMenuName = _const__WEBPACK_IMPORTED_MODULE_1__["MenuName"].TABLE;
  }
...
/***/ "./src/components/site-menu-title-component.js":
/*!*****************************************************!*\
  !*** ./src/components/site-menu-title-component.js ***!
  \*****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SiteMenuTitleComponent; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");


class SiteMenuTitleComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return (
...
/***/ "./src/components/statitstics-component.js":
/*!*************************************************!*\
  !*** ./src/components/statitstics-component.js ***!
  \*************************************************/
/*! exports provided: default */
...
const createStatisticsTemplate = () => {
  const diagramsTemplate = Object.values(_const__WEBPACK_IMPORTED_MODULE_2__["Statistic"]).map((it) => createStatisticTemplate(it)).join(``);
...
class StatisticsComponent extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _renderCharts() {
    ...
    this._moneyChart = Object(_utils_renderChart__WEBPACK_IMPORTED_MODULE_1__["renderMoneyChart"])(moneyCtx, this._eventsModel.getEvents());
    this._transportChart = Object(_utils_renderChart__WEBPACK_IMPORTED_MODULE_1__["renderTransportChart"])(transportCtx, this._eventsModel.getEvents());
    this._timeSpendChart = Object(_utils_renderChart__WEBPACK_IMPORTED_MODULE_1__["renderTimeSpendChart"])(timeSpendCtx, this._eventsModel.getEvents());
  }
...
/***/ "./src/components/trip-days-item-component.js":
/*!****************************************************!*\
  !*** ./src/components/trip-days-item-component.js ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripDaysItemComponent; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");


class TripDaysItemComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return (
...
/***/ "./src/components/trip-events-list-component.js":
/*!******************************************************!*\
  !*** ./src/components/trip-events-list-component.js ***!
  \******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripEventsListComponent; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");


class TripEventsListComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return (
...
/***/ "./src/components/trip-info-cost-component.js":
/*!****************************************************!*\
  !*** ./src/components/trip-info-cost-component.js ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripInfoCostComponent; });
/* harmony import */ var _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-smart-component */ "./src/components/abstract-smart-component.js");
...
class TripInfoCostComponent extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(events) {
    super();
    this._events = events;
  }
...
/***/ "./src/components/trip-info-main-component.js":
/*!****************************************************!*\
  !*** ./src/components/trip-info-main-component.js ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripInfoMainComponent; });
/* harmony import */ var _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-smart-component */ "./src/components/abstract-smart-component.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_1__);
...
const getPeriod = (events) => {
  ...
  if (startDate.getMonth() === endDate.getMonth()) {
    return {
      start: `${moment__WEBPACK_IMPORTED_MODULE_1___default()(startDate).format(`MMM`)} ${startDate.getDate()}`,
      end: `${endDate.getDate()}`,
    };
  } else {
    return {
      start: `${startDate.getDate()} ${moment__WEBPACK_IMPORTED_MODULE_1___default()(startDate).format(`MMM`)}`,
      end: `${endDate.getDate()} ${moment__WEBPACK_IMPORTED_MODULE_1___default()(endDate).format(`MMM`)}`,
    };
  }
};
...
class TripInfoMainComponent extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(events) {
    super();
    this._events = events;
  }
...
/***/ "./src/components/trip-main-event-add-btn-component.js":
/*!*************************************************************!*\
  !*** ./src/components/trip-main-event-add-btn-component.js ***!
  \*************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripMainEventAddBtnComponent; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");


class TripMainEventAddBtnComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return (
...
/***/ "./src/components/trip-sort-component.js":
/*!***********************************************!*\
  !*** ./src/components/trip-sort-component.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripSortComponent; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const */ "./src/const.js");
...
class TripSortComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(sorts) {
    super();
  ...
  setSortTypeChangeHandler(handler) {
    this.getElement().addEventListener(`change`, (evt) => {
      ...
      if (sortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT) {
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: EURO_SYMBOL, MenuName, menuNames, MILLISECONDS_PER_DAY, SortType, FilterType, EmptyEvent, Mode, Statistic, GroupType, groupToTypes, groupTypeToPreposition, typeToGroup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EURO_SYMBOL", function() { return EURO_SYMBOL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MenuName", function() { return MenuName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "menuNames", function() { return menuNames; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "groupToTypes", function() { return groupToTypes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "groupTypeToPreposition", function() { return groupTypeToPreposition; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "typeToGroup", function() { return typeToGroup; });
const EURO_SYMBOL = `\u20AC`;
const MenuName = {
  TABLE: `Table`,
  STATS: `Stats`,
...
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _components_filter_list_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/filter-list-component */ "./src/components/filter-list-component.js");
/* harmony import */ var _components_filter_list_title_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/filter-list-title-component */ "./src/components/filter-list-title-component.js");
...
class FilterController {
  constructor(container, eventsModel) {
    ...
    this._eventsModel = eventsModel;
    this._filterListTitleComponent = new _components_filter_list_title_component__WEBPACK_IMPORTED_MODULE_2__["default"]();

    this._filterListComponent = null;

    this._onDataChange = this._onDataChange.bind(this);
    this._onFilterChange = this._onFilterChange.bind(this);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["renderElement"])(this._container, this._filterListTitleComponent);
  ...
  render() {
    ...
    this._filterListComponent = new _components_filter_list_component__WEBPACK_IMPORTED_MODULE_1__["default"](this._eventsModel.getFilters());
    this._filterListComponent.setFilterTypeChangeHandler(this._onFilterChange);

    if (oldComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replaceElement"])(this._filterListComponent, oldComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["renderElement"])(this._container, this._filterListComponent);
    }
  }
...
/* harmony import */ var _components_event_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/event-component */ "./src/components/event-component.js");
/* harmony import */ var _components_event_edit_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/event-edit-component */ "./src/components/event-edit-component.js");
/* harmony import */ var _models_event_adapter_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/event-adapter-model */ "./src/models/event-adapter-model.js");
...
class PointController {
  ...
  render(eventAdapterModel, mode, backEndStaticData) {
    ...
    this._mode = mode;
    this._eventComponent = new _components_event_component__WEBPACK_IMPORTED_MODULE_1__["default"](eventAdapterModel);
    this._eventEditComponent = new _components_event_edit_component__WEBPACK_IMPORTED_MODULE_2__["default"](eventAdapterModel, backEndStaticData);
    ...
    this._eventEditComponent.setRollupButtonClickHandler(() => {
      if (this._mode === _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING) {
        this._onDataChange(this, _const__WEBPACK_IMPORTED_MODULE_5__["EmptyEvent"], null);
      } else {
    ...
    this._eventEditComponent.setFavoriteToggleHandler((isChange) => {
      ...
      const newEventAdapterModel = _models_event_adapter_model__WEBPACK_IMPORTED_MODULE_3__["default"].clone(eventAdapterModel);
    ...
    switch (mode) {
      case _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT:
        if (oldEventEditComponent && oldEventComponent) {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["replaceElement"])(this._eventComponent, oldEventComponent);
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["replaceElement"])(this._eventEditComponent, oldEventEditComponent);
        } else {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["renderElement"])(this._container, this._eventComponent);
        }
        break;
      case _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING:
        if (oldEventEditComponent && oldEventComponent) {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["removeElement"])(oldEventComponent);
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["removeElement"])(oldEventEditComponent);
        }
        document.addEventListener(`keydown`, this._onEscKeyDown);
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["renderElement"])(this._container, this._eventEditComponent, _utils_render__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].AFTEREND);
        break;
    }
  }

  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["removeElement"])(this._eventEditComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["removeElement"])(this._eventComponent);
    document.removeEventListener(`keydown`, this._onEscKeyDown);
  }
  ...
  _parseFormData({formData, destination, offers, typeToOffers}, eventAdapterModel) {
    return _models_event_adapter_model__WEBPACK_IMPORTED_MODULE_3__["default"].replenishOffers(typeToOffers.get(formData.get(`event-type`)), new _models_event_adapter_model__WEBPACK_IMPORTED_MODULE_3__["default"]({
      'id': eventAdapterModel.id,
      'type': formData.get(`event-type`),
      'date_from': new Date(moment__WEBPACK_IMPORTED_MODULE_0___default()(formData.get(`event-start-time`), `DD-MM-YY HH:mm`).utc().format()).toISOString(),
      'date_to': new Date(moment__WEBPACK_IMPORTED_MODULE_0___default()(formData.get(`event-end-time`), `DD-MM-YY HH:mm`).utc().format()).toISOString(),
      'destination': {
  ...
  _replaceEditToEvent() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["replaceElement"])(this._eventComponent, this._eventEditComponent);
    this._mode = _const__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT;
  }

  _replaceEventToEdit() {
    this._onViewChange();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["replaceElement"])(this._eventEditComponent, this._eventComponent);
...
/* harmony import */ var _components_empty_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/empty-component */ "./src/components/empty-component.js");
/* harmony import */ var _components_trip_info_main_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/trip-info-main-component */ "./src/components/trip-info-main-component.js");
/* harmony import */ var _components_trip_info_cost_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/trip-info-cost-component */ "./src/components/trip-info-cost-component.js");
/* harmony import */ var _components_trip_days_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/trip-days-component */ "./src/components/trip-days-component.js");
/* harmony import */ var _components_trip_events_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/trip-events-list-component */ "./src/components/trip-events-list-component.js");
/* harmony import */ var _components_trip_sort_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/trip-sort-component */ "./src/components/trip-sort-component.js");
/* harmony import */ var _components_day_info_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/day-info-component */ "./src/components/day-info-component.js");
/* harmony import */ var _components_trip_days_item_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/trip-days-item-component */ "./src/components/trip-days-item-component.js");
/* harmony import */ var _point_controller__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./point-controller */ "./src/controllers/point-controller.js");
/* harmony import */ var _models_event_adapter_model__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../models/event-adapter-model */ "./src/models/event-adapter-model.js");
...
class TripController {
  constructor(containerComponent, tripInfoElement, eventsModel, api) {
    ...
    this._tripSortComponent = new _components_trip_sort_component__WEBPACK_IMPORTED_MODULE_5__["default"](this._eventsModel.getSorts());
    this._tripDaysComponent = new _components_trip_days_component__WEBPACK_IMPORTED_MODULE_3__["default"]();
  ...
  render() {
    ...
    if (this._eventsModel.getEvents().length === 0) {
      this._emptyComponent = new _components_empty_component__WEBPACK_IMPORTED_MODULE_0__["default"]();
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["renderElement"])(this._container, this._emptyComponent);
      return;
    }

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["renderElement"])(this._container, this._tripSortComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["renderElement"])(this._container, this._tripDaysComponent);

    this._tripInfoMainComponent = new _components_trip_info_main_component__WEBPACK_IMPORTED_MODULE_1__["default"](this._eventsModel.getSortingDateEvents());
    this._tripInfoCostComponent = new _components_trip_info_cost_component__WEBPACK_IMPORTED_MODULE_2__["default"](this._eventsModel.getSortingDateEvents());
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["renderElement"])(this._tripInfoElement, this._tripInfoMainComponent, _utils_render__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].AFTERBEGIN);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["renderElement"])(this._tripInfoElement, this._tripInfoCostComponent, _utils_render__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  ...
  createEvent(tripMainEventAddBtnComponent) {
    ...
    if (this._emptyComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["removeElement"])(this._emptyComponent);
    }

    this._onViewChange();
    const tripSortElement = document.querySelector(`.trip-events__trip-sort`);
    this._creatingEventController = new _point_controller__WEBPACK_IMPORTED_MODULE_8__["default"](tripSortElement ?
      tripSortElement : this._container, this._onDataChange, this._onViewChange);
    this._creatingEventController.render(_const__WEBPACK_IMPORTED_MODULE_12__["EmptyEvent"], _const__WEBPACK_IMPORTED_MODULE_12__["Mode"].ADDING, this._backEndStaticData);
  }
  ...
  _renderEvents() {
    ...
    switch (this._eventsModel.getSortType()) {
      case _const__WEBPACK_IMPORTED_MODULE_12__["SortType"].EVENT:
  ...
  _renderTripDays(eventAdapterModels) {
    ...
    const dayCounts = tripDays.map((dayEvents, i) => {
      storageDay += i === 0 ? 1 : (Object(_utils_common__WEBPACK_IMPORTED_MODULE_11__["getExactDate"])(dayEvents[0].date.start) - Object(_utils_common__WEBPACK_IMPORTED_MODULE_11__["getExactDate"])(tripDays[i - 1][0].date.start)) / _const__WEBPACK_IMPORTED_MODULE_12__["MILLISECONDS_PER_DAY"];
      return storageDay;
    });
  ...
  _getTripDays(eventAdapterModels) {
    const days = [[]];
    let currentDate = Object(_utils_common__WEBPACK_IMPORTED_MODULE_11__["getExactDate"])(eventAdapterModels[0].date.start);
    eventAdapterModels.forEach((event) => {
      if (Object(_utils_common__WEBPACK_IMPORTED_MODULE_11__["formatDate"])(currentDate) === Object(_utils_common__WEBPACK_IMPORTED_MODULE_11__["formatDate"])(event.date.start)) {
        days[days.length - 1].push(event);
      } else {
        currentDate = Object(_utils_common__WEBPACK_IMPORTED_MODULE_11__["getExactDate"])(event.date.start);
        days.push([]);
        days[days.length - 1].push(event);
      }
    });
  ...
  _renderStructure(eventAdapterModels, date, dayCount) {
    const tripDaysItemComponent = new _components_trip_days_item_component__WEBPACK_IMPORTED_MODULE_7__["default"]();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["renderElement"])(this._tripDaysComponent.getElement(), tripDaysItemComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["renderElement"])(tripDaysItemComponent.getElement(), new _components_day_info_component__WEBPACK_IMPORTED_MODULE_6__["default"](date, dayCount));
    const tripEventsListComponent = new _components_trip_events_list_component__WEBPACK_IMPORTED_MODULE_4__["default"]();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["renderElement"])(tripDaysItemComponent.getElement(), tripEventsListComponent);
  ...
  _renderOneDayEvents(container, eventAdapterModels) {
    return eventAdapterModels.map((eventAdapterModel) => {
      const pointController = new _point_controller__WEBPACK_IMPORTED_MODULE_8__["default"](container, this._onDataChange, this._onViewChange);
      pointController.render(eventAdapterModel, _const__WEBPACK_IMPORTED_MODULE_12__["Mode"].DEFAULT, this._backEndStaticData);
  ...
  _updateEvents() {
    ...
    if (this._eventsModel.getEvents().length === 0) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["removeElement"])(this._tripInfoMainComponent);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["removeElement"])(this._tripSortComponent);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["removeElement"])(this._tripDaysComponent);
      this._emptyComponent = new _components_empty_component__WEBPACK_IMPORTED_MODULE_0__["default"]();
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["renderElement"])(this._container, this._emptyComponent);
  ...
  _onDataChange(pointController, oldEvent, newEventAdapterModel, isDoUpdateEvents = true) {
    if (oldEvent === _const__WEBPACK_IMPORTED_MODULE_12__["EmptyEvent"]) {
      this._creatingEventController = null;
      ...
      if (newEventAdapterModel === null) {
        ...
        this._api.createPoint(newEventAdapterModel)
          .then((eventAdapterModel) => {
            ...
            eventAdapterModel = _models_event_adapter_model__WEBPACK_IMPORTED_MODULE_9__["default"].replenishOffers(typeToOffers.get(eventAdapterModel.type), eventAdapterModel);
...
/* harmony import */ var _components_site_menu_title_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/site-menu-title-component */ "./src/components/site-menu-title-component.js");
/* harmony import */ var _components_site_menu_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/site-menu-component */ "./src/components/site-menu-component.js");
/* harmony import */ var _components_trip_main_event_add_btn_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/trip-main-event-add-btn-component */ "./src/components/trip-main-event-add-btn-component.js");
/* harmony import */ var _components_trip_events_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/trip-events-component */ "./src/components/trip-events-component.js");
/* harmony import */ var _components_statitstics_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/statitstics-component */ "./src/components/statitstics-component.js");
/* harmony import */ var _controllers_trip_controller__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./controllers/trip-controller */ "./src/controllers/trip-controller.js");
/* harmony import */ var _controllers_filter_controller__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./controllers/filter-controller */ "./src/controllers/filter-controller.js");
...
/* harmony import */ var _models_events_model__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./models/events-model */ "./src/models/events-model.js");
/* harmony import */ var _models_event_adapter_model__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./models/event-adapter-model */ "./src/models/event-adapter-model.js");
...
const api = new _api__WEBPACK_IMPORTED_MODULE_0__["default"](END_POINT, AUTHORIZATION);
...
const eventsModel = new _models_events_model__WEBPACK_IMPORTED_MODULE_10__["default"]();

const tripMainElement = document.querySelector(`.trip-main`);

const tripMainEventAddBtnComponent = new _components_trip_main_event_add_btn_component__WEBPACK_IMPORTED_MODULE_3__["default"]();
Object(_utils_render__WEBPACK_IMPORTED_MODULE_9__["renderElement"])(tripMainElement, tripMainEventAddBtnComponent);

const tripInfoElement = tripMainElement.querySelector(`.trip-info`);

const tripControlsElement = tripMainElement.querySelector(`.trip-controls`);

const siteMenuTitleComponent = new _components_site_menu_title_component__WEBPACK_IMPORTED_MODULE_1__["default"]();
const siteMenuComponent = new _components_site_menu_component__WEBPACK_IMPORTED_MODULE_2__["default"](_const__WEBPACK_IMPORTED_MODULE_8__["menuNames"]);
Object(_utils_render__WEBPACK_IMPORTED_MODULE_9__["renderElement"])(tripControlsElement, siteMenuTitleComponent);
Object(_utils_render__WEBPACK_IMPORTED_MODULE_9__["renderElement"])(tripControlsElement, siteMenuComponent);

const filterController = new _controllers_filter_controller__WEBPACK_IMPORTED_MODULE_7__["default"](tripControlsElement, eventsModel);

const pageBodyContainerElement = document.querySelector(`.page-body__page-main .page-body__container`);
const tripEventsComponent = new _components_trip_events_component__WEBPACK_IMPORTED_MODULE_4__["default"]();
const statisticsComponent = new _components_statitstics_component__WEBPACK_IMPORTED_MODULE_5__["default"](eventsModel);
Object(_utils_render__WEBPACK_IMPORTED_MODULE_9__["renderElement"])(pageBodyContainerElement, tripEventsComponent);
Object(_utils_render__WEBPACK_IMPORTED_MODULE_9__["renderElement"])(pageBodyContainerElement, statisticsComponent);

const tripController = new _controllers_trip_controller__WEBPACK_IMPORTED_MODULE_6__["default"](tripEventsComponent, tripInfoElement, eventsModel, apiWithProvider);
...
siteMenuComponent.setChangeHandler((menuName) => {
  switch (menuName) {
    case _const__WEBPACK_IMPORTED_MODULE_8__["MenuName"].TABLE:
      statisticsComponent.hide();
      pageBodyContainerElement.classList.remove(`disable-line`);
      tripController.show();
      filterController.show();
      break;
    case _const__WEBPACK_IMPORTED_MODULE_8__["MenuName"].STATS:
      tripController.hide();
...
Promise.all([
  ...
  eventAdapterModels.forEach((it) => {
    _models_event_adapter_model__WEBPACK_IMPORTED_MODULE_11__["default"].replenishOffers(typeToOffers.get(it.type), it);
  });
    ...
    apiWithProvider.sync()
      .then((syncedEndEvents) => {
        const eventAdapterModels = syncedEndEvents.map((it) => {
          it = _models_event_adapter_model__WEBPACK_IMPORTED_MODULE_11__["default"].parseEvent(it);
          return _models_event_adapter_model__WEBPACK_IMPORTED_MODULE_11__["default"].replenishOffers(typeToOffers.get(it.type), it);
        });
        eventsModel.setEvents(eventAdapterModels);
...
/***/ "./src/models/destination-adapter-model.js":
/*!*************************************************!*\
  !*** ./src/models/destination-adapter-model.js ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DestinationAdapterModel; });
class DestinationAdapterModel {
  constructor(endData) {
...
/***/ "./src/models/event-adapter-model.js":
/*!*******************************************!*\
  !*** ./src/models/event-adapter-model.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventAdapterModel; });
class EventAdapterModel {
  constructor(endData) {
    this.id = endData[`id`];
...
class EventsModel {
  constructor() {
    ...
    this._activeSortType = _const__WEBPACK_IMPORTED_MODULE_0__["SortType"].EVENT;
  ...
  getFilters() {
    const nowDate = new Date();
    return Object.values(_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"]).map((filterType) => {
      return {
        name: filterType,
  ...
  getSorts() {
    return Object.values(_const__WEBPACK_IMPORTED_MODULE_0__["SortType"]).map((sortType) => {
      return {
        name: sortType,
        isChecked: sortType === this._activeSortType,
        haveSvg: sortType !== _const__WEBPACK_IMPORTED_MODULE_0__["SortType"].EVENT,
      };
    });
  }
...
/***/ "./src/models/offer-adapter-model.js":
/*!*******************************************!*\
  !*** ./src/models/offer-adapter-model.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return OffersAdapterModel; });
class OffersAdapterModel {
  constructor(endData) {
    this._endData = endData;
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: formatTime, formatDate, getDuration, getExactDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getExactDate", function() { return getExactDate; });
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);
...
const getDuration = (start, end) => {
  const interval = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(end - start);
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: createElement, renderElement, removeElement, RenderPosition, replaceElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/utils/renderChart.js":
/*!**********************************!*\
  !*** ./src/utils/renderChart.js ***!
  \**********************************/
/*! exports provided: renderMoneyChart, renderTransportChart, renderTimeSpendChart */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderMoneyChart", function() { return renderMoneyChart; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderTransportChart", function() { return renderTransportChart; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderTimeSpendChart", function() { return renderTimeSpendChart; });
...
const getTransportToEventCount = (events) => {
  ...
  events.forEach((it) => {
    if (_const__WEBPACK_IMPORTED_MODULE_2__["typeToGroup"].get(it.type) !== _const__WEBPACK_IMPORTED_MODULE_2__["GroupType"].TRANSFER) {
      return;
    }
...
const getTypeToEventHour = (events) => {
  ...
  const getHoursDuration = (event) => moment__WEBPACK_IMPORTED_MODULE_1___default.a.duration(event.date.end - event.date.start).hours();
  events.forEach((it) => {
...
const renderMoneyChart = (moneyCtx, events) => {
  ...
  chartConfig.options.title.text = _const__WEBPACK_IMPORTED_MODULE_2__["Statistic"].MONEY.toUpperCase();
  chartConfig.options.plugins.datalabels.formatter = (value) => `${_const__WEBPACK_IMPORTED_MODULE_2__["EURO_SYMBOL"]} ${value}`;

  return new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(moneyCtx, chartConfig);
};
...
const renderTransportChart = (transportsCtx, events) => {
  ...
  chartConfig.options.title.text = _const__WEBPACK_IMPORTED_MODULE_2__["Statistic"].TRANSPORT.toUpperCase();
  chartConfig.options.plugins.datalabels.formatter = (value) => `${value}x`;

  return new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(transportsCtx, chartConfig);
};
...
const renderTimeSpendChart = (timeSpendCtx, events) => {
  ...
  chartConfig.options.title.text = _const__WEBPACK_IMPORTED_MODULE_2__["Statistic"].TIME_SPEND.toUpperCase();
  chartConfig.options.plugins.datalabels.formatter = (value) => `${value}H`;

  return new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(timeSpendCtx, chartConfig);
};
